...
% web: http://www.texample.net/tikz/examples/karnaugh-diagram/
...
%%paquete para cambiar color de fuentes 
%%\usepackage{xcolor}
...
\usepackage{pdfpages}   %para agregar pdfs(Karnaugh)
\usepackage{bm}
...
\input{Extras/Config.tex}

\pagestyle{fancy}
\fancyhf{}
\rhead{Trabajo Práctico $N^\circ1$}
\lhead{22.12 - Electr\'onica III}
\rfoot{Página \thepage}
